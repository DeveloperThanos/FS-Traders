  ...
  "spices": {
    ...
    "items": [
      { 
        ...
        "en": { "imageName": "Black Pepper", "origins": ["Vietnam", "India", "Sri Lanka"] },
        "zh": { "imageName": "黑胡椒", "origins": ["越南", "印度", "斯里兰卡"] },
        "si": { "imageName": "කළු ගම්මිරිස්", "origins": ["වියට්නාමය", "ඉන්දියාව", "ශ්‍රී ලංකාව"] }
      },
      { 
        "imagePath": "/assets/products/Export/Spices/cinnamon.jpg", 
        "en": { "imageName": "Cinnamon", "origins": ["Sri Lanka", "Indonesia"] },
        "zh": { "imageName": "肉桂", "origins": ["斯里兰卡", "印度尼西亚"] },
        "si": { "imageName": "දොල් චිනි", "origins": ["ශ්‍රී ලංකාව", "ඉන්දුනීසියාව"] }
      },
      { 
        "imagePath": "/assets/products/Export/Spices/cardamom.jpg", 
        "en": { "imageName": "Cardamom", "origins": ["Guatemala", "India"] },
        "zh": { "imageName": "小豆蔻", "origins": ["危地马拉", "印度"] },
        "si": { "imageName": "කොත්තමල්ලි", "origins": ["ගුවාටමාලාව", "ඉන්දියාව"] }
      },
      { 
        "imagePath": "/assets/products/Export/Spices/cloves.jpg", 
        "en": { "imageName": "Cloves", "origins": ["Indonesia", "Madagascar"] },
        "zh": { "imageName": "丁香", "origins": ["印度尼西亚", "马达加斯加"] },
        "si": { "imageName": "රත කුරුදු", "origins": ["ඉන්දුනීසියාව", "මැඩගස්කර්"] }
      }
    ]
  },
  "tea": {
    "en": { "category": "Tea", "assetName": "Tea" },
    "zh": { "category": "茶", "assetName": "Tea" },
    "si": { "category": "තේ", "assetName": "Tea" },
    "items": [
      { 
        "imagePath": "/assets/products/Export/Tea/ceylon-black-tea.jpg", 
        "en": { "imageName": "Ceylon Black Tea", "origins": ["Nuwara Eliya", "Uva", "Dimbula"] },
        "zh": { "imageName": "錫蘭紅茶", "origins": ["努瓦拉埃利耶", "烏瓦", "丁布拉"] },
        "si": { "imageName": "සිලෝන් කළු තේ", "origins": ["නුවරඑළිය", "උවා", "දිඹුල"] }
      },
      { 
        "imagePath": "/assets/products/Export/Tea/green-tea.jpg", 
        "en": { "imageName": "Ceylon Green Tea", "origins": ["Uva Province"] },
        "zh": { "imageName": "錫蘭綠茶", "origins": ["烏瓦省"] },
        "si": { "imageName": "සිලෝන් කොළ තේ", "origins": ["උවා පළාත"] }
      },
      { 
        "imagePath": "/assets/products/Export/Tea/white-tea.jpg", 
        "en": { "imageName": "Ceylon White Tea", "origins": ["Nuwara Eliya"] },
        "zh": { "imageName": "錫蘭白茶", "origins": ["努瓦拉埃利耶"] },
        "si": { "imageName": "සිලෝන් සුදු තේ", "origins": ["නුවරඑළිය"] }
      },
      { 
        "imagePath": "/assets/products/Export/Tea/oolong-tea.jpg", 
        "en": { "imageName": "Ceylon Oolong Tea", "origins": ["Uva"] },
        "zh": { "imageName": "錫蘭烏龍茶", "origins": ["烏瓦"] },
        "si": { "imageName": "සිලෝන් ඌලෝං තේ", "origins": ["උවා"] }
      }
    ]
  },
  "coconut": {
    "en": { "category": "Coconut Products", "assetName": "Coconut" },
    "zh": { "category": "椰子产品", "assetName": "Coconut" },
    "si": { "category": "පොල් නිෂ්පාදන", "assetName": "Coconut" },
    "items": [
      { 
        "imagePath": "/assets/products/Export/Coconut/dessicated-coconut.jpg", 
        "en": { "imageName": "Desiccated Coconut", "origins": ["Western Province", "North Western"] },
        "zh": { "imageName": "脱水椰子", "origins": ["西部省", "西北省"] },
        "si": { "imageName": "වියළි පොල්", "origins": ["බස්නාහිර පළාත", "වයඹ පළාත"] }
      },
      { 
        "imagePath": "/assets/products/Export/Coconut/coconut-oil.jpg", 
        "en": { "imageName": "Virgin Coconut Oil", "origins": ["Puttalam", "Kurunegala"] },
        "zh": { "imageName": "初榨椰子油", "origins": ["普塔拉姆", "庫魯內加拉"] },
        "si": { "imageName": "කුමරිකා පොල් තෙල්", "origins": ["පුත්තලම", "කුරුණෑගල"] }
      },
      { 
        "imagePath": "/assets/products/Export/Coconut/coconut-milk.jpg", 
        "en": { "imageName": "Coconut Milk Powder", "origins": ["All Islands"] },
        "zh": { "imageName": "椰奶粉", "origins": ["全島"] },
        "si": { "imageName": "පොල් කිරි පොඩි", "origins": ["සමස්ත දූපත්"] }
      },
      { 
        "imagePath": "/assets/products/Export/Coconut/fresh-coconut.jpg", 
        "en": { "imageName": "Fresh Coconut", "origins": ["Coconut Triangle"] },
        "zh": { "imageName": "新鮮椰子", "origins": ["椰子三角區"] },
        "si": { "imageName": "නැවුම් පොල්", "origins": ["පොල් ත්‍රිකෝණය"] }
      }
    ]
  }
}
